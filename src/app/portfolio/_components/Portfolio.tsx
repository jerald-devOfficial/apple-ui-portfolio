  ...
  return (
    <div className="flex grow h-full rounded-xl bg-stone-200/95 dark:bg-zinc-900 flex-col shadow-xl overflow-hidden">
      <div className="flex border-b-[0.3px] border-gray-400/60 sm:border-gray-300/90 dark:border-zinc-700 border-solid">
        ...
        <div
          className={`flex-1 px-4 pt-2.5 pb-3 hidden md:flex gap-x-4 h-23 flex-col justify-between items-center bg-white/95 dark:bg-zinc-800/95 overflow-hidden ${
        ...
        <div className="flex items-center justify-between sm:order-2 md:order-[initial] md:w-1/3 md:justify-center md:border-r-[0.3px] md:border-r-gray-300 dark:md:border-r-zinc-700 md:items-baseline">
          <div className="flex flex-row md:flex-col py-1 md:py-0 items-baseline gap-x-6 justify-evenly w-full md:mt-6 md:mx-4 md:bg-white dark:md:bg-zinc-800 md:rounded-xl md:pl-4">
            {icons.map((icon, index) => (
              <button
                className={`grid place-content-center place-items-center gap-y-1.5 xs:w-15.5 cursor-pointer md:flex md:items-center md:justify-between group md:w-full md:flex-row-reverse md:px-6 md:py-3.5 md:pr-3 md:pl-0 ${
              ...
              >
                <span className="rounded-full bg-white dark:bg-zinc-700 group-hover:bg-stone-50 dark:group-hover:bg-zinc-600 grid place-items-center p-4 xs:w-15.5 xs:h-15.5 w-10 h-10 md:h-4 md:w-4 place-content-center">
                  <icon.icon
                    className={`${
                      activeCategory === index
